...
<meta content='Nguyễn Văn Quyến' property='og:title'/>
<meta content='Xây dựng và phát triển bởi Nguyễn Văn Quyến!' property='og:description'/>
...
<div class='profile-card__txt'>Tôi là <b>Nguyễn Văn Quyến</b>, một cậu sinh học sinh cấp 2 sắp lên cấp 3 yeye chuyên <b>Hỗ trợ Dịch vụ Mạng Xã Hội</b> với ước mơ trở thành một Developer chuyên nghiệp. Tôi thích khám phá, tìm tòi và học hỏi những điều thú vị trên mạng Internet. Biết đôi chút về <i>C/C++/C#, Python, HTML5/CSS3, JavaScript, Node.js, React native</i> ...</div>
<div class='profile-card-loc'>
<span class='profile-card-loc__icon'>
<svg class='icon'><use xlink:href='#icon-location'></use></svg>
</span>
<span class='profile-card-loc__txt'>Thái Nguyên</span>
</div>
...
<a class='profile-card-social__item facebook' href='https://www.facebook.com/vanquyen.nguyen.3954' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-facebook'></use></svg>
</span>
</a>
<a class='profile-card-social__item link' href='http://fuzzyh2t.com' target='_blank'>
<span class='icon-font'>
